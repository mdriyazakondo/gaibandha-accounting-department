...
import {
  ...
  FaInstagram,
  FaTwitter,
  FaEnvelope, // ইমেইলের জন্য নতুন আইকন
} from "react-icons/fa";

const TeacherLightBox = ({ selectedStudent, close }) => {
  // যদি রোল টিচার হয় তবে আমরা designation এবং experience দেখাবো
      ...
      >
        ...
        <div className="p-8 flex flex-col items-center">
          ...
          <p className="text-primary font-bold text-lg">
            {isTeacher ? selectedStudent.designation : selectedStudent.role}
          </p>
          ...
          <div className="flex gap-4 mb-8">
            ...
            />
            {/* যদি টিচার হয় তবে ইমেইল আইকন দেখাবে, না হলে ইনস্টাগ্রাম */}
            {isTeacher ? (
              <SocialIcon
          ...
          {/* Stats Grid (Updated for Teacher Data) */}
          <div className="grid grid-cols-2 gap-4 w-full mb-6">
            <div className="bg-gray-50 rounded-2xl p-4 text-center border border-gray-100">
              ...
              <p className="text-xl font-black text-gray-800">
                {isTeacher ? selectedStudent.experience : selectedStudent.gpa}
              </p>
            </div>
            <div className="bg-gray-50 rounded-2xl p-4 text-center border border-gray-100">
              <p className="text-[10px] text-gray-400 uppercase font-bold tracking-widest">
              ...
              <p className="text-sm font-bold text-gray-800 mt-1 uppercase">
                {isTeacher
                  ? selectedStudent.designation.split(" ")[0]
